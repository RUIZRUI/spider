...
def getGameData(gameUrl):
	...
	getGameIntroduction.insertIntroduction(gameDataDict['id'], 'i_'+gameDataDict['name'], gameIntroduction)
...
def getJson(filePath):
	...
	with open(filePath, 'r') as fp:
		...
		rootDir = properties['rootDir'] + 'iosGame\\'
		imgUrl = properties['imgUrl'] + 'iosGame/'
