...
# 目标 url
url = 'https://mooc1-1.chaoxing.com/work/getAllWork?classId=51876029&courseId=223137437&isdisplaytable=2&mooc=1&ut=t&enc=0a42d14fca324163cc1467660dd276e2&cpi=93844352&openc=31aea7eb6e55d090fdd12012590e10d4'
tableUrlPre = 'https://mooc1-1.chaoxing.com/work/searchMarkList?sw=&courseId=223137437&classId=51876029&isdisplaytable=2&isWork=true&tempClassId=51876029&dengji=0&firstHeader=2&schoolId=-1&schoolName=&sort=-1&order=0&workSystem=0&openc=31aea7eb6e55d090fdd12012590e10d4'
pageNumPre = 'pageNum='
scoreList = []
...
def getScoreByPage(tableUrl, pageNum):
    ...
    获取一次作业其中一页的分数
    '''
    tableUrl = tableUrl + '&' + pageNumPre + str(pageNum+1)
...
if __name__ == '__main__':
    ...
    # 解析
    soup = BeautifulSoup(ret.text, 'html.parser')
    a_workId = soup.findAll(name='a', attrs={'class': 'Btn_blue_1'})
    workIdList = []
    for a in a_workId:
        # print(a.get('href'))
        a_href = a.get('href')
