    ...
    for row in sheet1.iter_rows():
        ...
        for cell in row:
            ...
            if counter == 0:
                ...
                originalScore = cell.value
                totalScore = float(score) + float(originalScore)
                cell.value = totalScore
                print('sid=', sid, ', score=', score, ', originalScore=', originalScore, ', totalScore=', totalScore)
            counter += 1
